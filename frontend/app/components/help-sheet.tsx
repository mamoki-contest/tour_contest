  ...
  return (
    <OverlaySheet title="이 화면의 정보들" onClose={onClose}>
      <HelpItem title="온라인 언급">
        ...
        지금 그곳이 붐비는지도 아니에요. 목록 정렬은 이 값을 씁니다. 카드에는 적지
        않아요 — 어디를 볼지 고르는 데 쓰는 값이 아니라 순서를 정하는 값이라서요.
        이름이 모호하거나 집계하지 못한 곳은 순서를 매기지 못해, 목록 끝에
        `순서를 매기지 못한 N곳` 아래로 따로 모아요. 순위가 낮다는 뜻이 아니에요.
      </HelpItem>
